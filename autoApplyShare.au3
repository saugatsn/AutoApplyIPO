...
$logFile = FileOpen("autoit_execution.log", 2) ; 2 = overwrite mode
...
; Optional: Set the working directory to where main.py is located
; Uncomment and modify the line below if needed
; FileChangeDir("C:\Path\To\Your\Script")
...
$pid = Run(@ComSpec & ' /c python main.py', "", @SW_HIDE)
